 ...
 */
internal fun addViewsAtAnchorEdge(
    adapterIndex: Int,
    layoutManager: LoopingLayoutManager,
    itemCount: Int
): Int {
 ...
 * the recycler was initially laid out.
 */
internal fun addViewsAtOptAnchorEdge(
    adapterIndex: Int,
    layoutManager: LoopingLayoutManager,
    itemCount: Int
): Int {
 ...
 * direction.
 */
internal fun estimateShortestRoute(
    adapterIndex: Int,
    layoutManager: LoopingLayoutManager,
    itemCount: Int
): Int {
    ...
    val minDist = arrayOf(
        topLeftInLoopDist, topLeftOverSeamDist,
        bottomRightInLoopDist, bottomRightOverSeamDist
    ).minOrNull()
